...
execute_process(
  COMMAND "/usr/bin/git" show-ref "release-2.8.2"
  WORKING_DIRECTORY "/home/francesco/Desktop/TheTest/build/_deps/sdl2_image-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/francesco/Desktop/TheTest/build/_deps/sdl2_image-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/francesco/Desktop/TheTest/build/_deps/sdl2_image-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
